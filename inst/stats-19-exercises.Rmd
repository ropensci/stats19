...
# Upload exercises
file.rename("inst/stats-19-exercises.pdf", ".")
...
If you don't see the prerequisites at [docs.ropensci.org](https://docs.ropensci.org/stats19/articles/stats19-training-setup.html).
...
write this code into your new R script and execute the result line-by-line by pressing Ctl+Enter
...
There are several ways to run code within a script.
...
download.file(url = "https://geocompr.robinlovelace.net/figures/vector_lonlat.png", destfile = "vector_lonlat.png")
download.file("https://geocompr.robinlovelace.net/figures/vector_projected.png", "vector_projected.png")
