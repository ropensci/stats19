...
If you are new to R, please read-up and more importantly **test out** R and RStudio before the course.
...
If you cannot create a map by running the code above before the course, get in touch.
