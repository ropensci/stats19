...
If you cannot create that map by running the code above before the course, get in touch with us creating a new comment under that github issue page (Note: You will need a github account). 
