...
It helps with data discovery, download, cleaning and formatting, allowing you to focus on the real work of analysis.
...
- Comparing these datasets with interventions such as 20 mph zones, building on previous work [@grundy_effect_2009].
- The creation of more general software for accessing and working with road crash data worldwide.
- Making the data even more available by provide the data as part of an interactive web application, a technique successfully used in the Propensity to Cycle Tool (PCT) project hosted at [www.pct.bike/](http://www.pct.bike/) [@lovelace_propensity_2017] (this would likely take further times/resources beyond what we can provide in our spare time!).
