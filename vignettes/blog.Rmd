...
The importance of road safety and informed decision making based on crash data, in our view, cannot be overrated. Two numbers from a [strategy](https://assets.publishing.service.gov.uk/government/uploads/system/uploads/attachment_data/file/8146/strategicframework.pdf) document from the UK government (2011) is worth mentioning here: 
