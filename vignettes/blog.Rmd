...
We started the package in late 2018 following three main developments:
...
Furthermore, we have a wider motivation: we want the roads to be safer.
...
Even more shocking are the global statistics, as summarised by an open access and reproducible academic [paper that uses data from the package to explore car-pedestrian crashes](https://github.com/Robinlovelace/stats19-gisruk):
...
With those introductions out of the way, lets see what the package can do and how it can empower academics, policy makers, road safety campaigners and other R programmers to have access to a large dataset from 1979 - now. 
