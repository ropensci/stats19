...
This vignette focusses on how to use this package to work with STATS19 data.

The development version is hosted on [GitHub](https://github.com/ITSLeeds/stats19).
