...
Note that this is the same file (containing the 'accidents' table from 2017) downloaded previously with the command `dl_stats19(years = 2017, type = "Accidents")`.
