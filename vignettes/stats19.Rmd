...
crashes_joined
```
This join operation has enabled us to geo-reference the casualty data, enabling us to explore the spatial distribution of different casualty types as follows:
