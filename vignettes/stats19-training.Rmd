...
knitr::include_graphics("https://raw.githubusercontent.com/ropensci/stats19/87aff1494e09d34d9d2fcb55ca33b5a979dd17e5/inst/rstudio-autocomplete.png")
```
...
`ggplot2` is a generic plotting package that is part of the ['tidyverse'](https://tidyverse.org/) meta-package, which is an "opinionated collection of R packages designed for data science". 
...
1. **Bonus (difficult):** run the following code, which downloades data for car crashes occurred during 2022.
...
See [Chapter 6](https://r.geocompx.org/read-write.html) of Geocomputation with R for further information.
...
See [Chapter 4](https://r.geocompx.org/spatial-operations.html) of Geocomputation with R [@lovelace_geocomputation_2019] for further information on geographic joins.
...
For more information on CRSs see [Chapter 6](https://r.geocompx.org/reproj-geo-data.html) of Geocompuation with R.
