...
* `schema_new.Rmd` updated the lookup tables for the package based on the DfT variables xlsx file. This file has been changed to `schema_new.R` which should speed up updates (#291)
