---
title: "Reproducing _Reported road casualties in Great Britain: pedestrian factsheet, 2022_"
author: "Blaise Kelly"
format: html
editor: source
self-contained: true
...
# 
# ## request vehicle
# vehicles = get_stats19(year = y, type = "vehicle", ask = FALSE, format = TRUE, output_format = "data.frame")%>%
#   select(-accident_year)
# 
# 
...
#   veh_list[[as.character(y)]] <- vehicles
# 
# }
# 
# ## extract from list
...
# all_veh <- do.call(rbind,veh_list)
# 
...
## save having to import each time
#save(crash_cas, crash_veh, all_cra,all_cas, all_veh, file = "all_years.RData")
