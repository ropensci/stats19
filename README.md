...
likely to
change.](https://img.shields.io/badge/lifecycle-stable-blue.svg)](https://www.tidyverse.org/lifecycle/#maturing)
[![Travis build
...
#> Data saved at /tmp/RtmpoffMp5/dftRoadSafetyData_Accidents_2017/Acc.csv
#> Reading in:
#> /tmp/RtmpoffMp5/dftRoadSafetyData_Accidents_2017/Acc.csv
```
...
#> Attempt downloading from:
#> Data saved at /tmp/RtmpoffMp5/dftRoadSafetyData_Casualties_2017/Cas.csv
nrow(casualties)
#> [1] 170993
ncol(casualties)
#> [1] 16
...
#> Attempt downloading from:
#> Data saved at /tmp/RtmpoffMp5/dftRoadSafetyData_Vehicles_2017/Veh.csv
nrow(vehicles)
#> [1] 238926
ncol(vehicles)
#> [1] 23
