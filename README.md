...
#> Data saved at /tmp/RtmplYCTov/dftRoadSafetyData_Accidents_2017/Acc.csv
#> Reading in:
#> /tmp/RtmplYCTov/dftRoadSafetyData_Accidents_2017/Acc.csv
```
...
#> Attempt downloading from:
#> Data saved at /tmp/RtmplYCTov/dftRoadSafetyData_Casualties_2017/Cas.csv
nrow(casualties)
#> [1] 170993
ncol(casualties)
#> [1] 16
...
#> Attempt downloading from:
#> Data saved at /tmp/RtmplYCTov/dftRoadSafetyData_Vehicles_2017/Veh.csv
nrow(vehicles)
#> [1] 238926
ncol(vehicles)
#> [1] 23
