...
**Note**: The Department for Transport calls this table 'accidents' but 'crashes' is a more appropriate terms, according to road safety advocacy groups such as [RoadPeace](http://www.roadpeace.org/take-action/crash-not-accident/).
