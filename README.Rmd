...
```
To download other years it is worth being aware of the file structure of [the files, hosted by the DfT](https://www.gov.uk/government/statistical-data-sets/road-safety-open-data), this package imports. The last 5 years of data (usually released September for the previous year) are duplicated 3 times and available as individual years, or 1 file covering all 5 years. The data goes all the way back to 1979 (one of (if not the) the longest running collision statistics databases in the world). This data is stored in one very large file (~1GB) and also covers the last 5 years.
