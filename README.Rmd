...
The data is provided by the UK's Department for Transport (DfT) as a series of `.csv` files that are stored in dozens of `.zip` files.
...
Data files from other years can be downloaded in an interactive manner. Providing just the year for example, would present the following options:
