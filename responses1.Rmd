...
A CONTRIBUTING will be added at some point.
...
As it used for CyIPT project, it might still stay where it is, but clearly this package is taking over and it is just a matter of adapting the use by the CyIPT and other users.
