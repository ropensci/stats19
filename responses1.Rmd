...
@mem48 answered this: cyipt/stats19 is actually not an R package. It is a repo which is used for CyIPT project, it has different sources (UK DS), and usage so there is no current need to adapt the use to this package. Malcolm is one of the contributors to this package.
